<?php
/**
 * firstbyte functions and definitions
 *
...
function firstbyte_scripts() {
	wp_enqueue_style( 'firstbyte-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'firstbyte-style', 'rtl', 'replace' );

	wp_enqueue_script( 'firstbyte-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
